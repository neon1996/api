...
public class LocalDAOTest {
    ...
    public void testCreate() throws Exception {
        ...
        Local obj = new Local(0, "TestSigle", "TestPlaces", "TestDescription");
        LocalDAO instance = new LocalDAO();
        instance.setConnection(dbConnect);
        Local expResult = new Local(0, "TestSigle", "TestPlaces", "TestDescription");
        ...
        obj = new Local(0, "TestSigle", "TestPlaces", "TestDescription");
    ...
    public void testRechDescription() throws Exception {
        ...
        Local obj1 = new Local(0, "TestSigle", "TestPlaces", "TestDescription");
        Local obj2 = new Local(0, "TestSigle2", "TestPlaces2", "TestDescription2");
